...
source("~/Desktop/facebookdeprivation_bh-master/scripts/1.4-online-networks.R")
# ensure that your working directory is properly set
...
coef.vec_fig3 <- c(reg_res_mod1("outgroup_index",final_data[final_data$shannon_difference==1,])$estimate, reg_res_mod1("outgroup_index",final_data[final_data$majority_group_difference==1,])$estimate, reg_res_mod1("outgroup_index",final_data[final_data$fract_difference==1,])$estimate)
se.vec_fig3 <-  c(reg_res_mod1("outgroup_index",final_data[final_data$shannon_difference==1,])$std.error, reg_res_mod1("outgroup_index",final_data[final_data$majority_group_difference==1,])$std.error, reg_res_mod1("outgroup_index",final_data[final_data$fract_difference==1,])$std.error)

plot(coef.vec_fig3, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)", ylab = "", pch = c(19,17,12),cex = 1.2,
...
var.names <- c("Out-Group \n Index (SE)","Out-Group \n Index (MS)","Out-Group \n Index (EF)")
axis(1, at = seq(-1,1,by=0.5), labels =c(-1,0.5,0,0.5,1) , tick = T,
     cex.axis = 1, mgp = c(4,2,1))
axis(2, at = y.axis, label = var.names, las = 1, tick = T, mgp = c(1.6,.7,0),cex.axis = 1)

# heterogenous - right panel

coef.vecfigx <- c(reg_res_mod1("outgroup_index",final_data[final_data$shannon_difference==0,])$estimate, reg_res_mod1("outgroup_index",final_data[final_data$majority_group_difference==0,])$estimate, reg_res_mod1("outgroup_index",final_data[final_data$fract_difference==0,])$estimate)
se.vecfigx <-  c(reg_res_mod1("outgroup_index",final_data[final_data$shannon_difference==0,])$std.error, reg_res_mod1("outgroup_index",final_data[final_data$majority_group_difference==0,])$std.error, reg_res_mod1("outgroup_index",final_data[final_data$fract_difference==0,])$std.error)

plot(coef.vecfigx, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)", ylab = "", pch = c(19,17,12),cex = 1.2,
...
coef.vec_fig3 <- c(reg_res_mod1("outgroup_princomp",final_data[final_data$shannon_difference==1,])$estimate, reg_res_mod1("outgroup_princomp",final_data[final_data$majority_group_difference==1,])$estimate, reg_res_mod1("outgroup_princomp",final_data[final_data$fract_difference==1,])$estimate)
se.vec_fig3 <-  c(reg_res_mod1("outgroup_princomp",final_data[final_data$shannon_difference==1,])$std.error, reg_res_mod1("outgroup_princomp",final_data[final_data$majority_group_difference==1,])$std.error, reg_res_mod1("outgroup_princomp",final_data[final_data$fract_difference==1,])$std.error)
...
# heterogenous - right panel
coef.vecfigx <- c(reg_res_mod1("outgroup_princomp",final_data[final_data$shannon_difference==0,])$estimate, reg_res_mod1("outgroup_princomp",final_data[final_data$majority_group_difference==0,])$estimate, reg_res_mod1("outgroup_princomp",final_data[final_data$fract_difference==0,])$estimate)
se.vecfigx <-  c(reg_res_mod1("outgroup_princomp",final_data[final_data$shannon_difference==0,])$std.error, reg_res_mod1("outgroup_princomp",final_data[final_data$majority_group_difference==0,])$std.error, reg_res_mod1("outgroup_princomp",final_data[final_data$fract_difference==0,])$std.error)
