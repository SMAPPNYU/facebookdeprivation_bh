...
source("~/Desktop/facebookdeprivation_bh-master/scripts/1.3-offline-networks.R") # loading the previous script
# ensure that your working directory is set accordingly
...
par(mar=c(7, 10, 0, 0))
plot(coef.vec, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)", cex.lab=1.1,ylab = "", pch = 19,cex = 1,
...
axis(2, at = y.axis, label = var.names, las = 1, tick = T, mgp = c(1.6,.7,0),cex.axis = 1.1) 
...
plot(coef.vec_outgroup, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)" , cex.lab=1.1,ylab = "", pch = 19,cex = 1,
...
plot(coef.vec_fig3, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)", ylab = "", pch = c(19,17,12),cex = 1.2,
     xlim = c(-1,1), xaxs = "r", main = "Homogeneous", col=c("black","blue","red"), cex.lab=0.9)
...
adjust = 0.26
plot(coef.vec_fig3, y.axis, type = "p", axes = F, xlab = "Treatment effect (SD)", ylab = "", pch = c(19,17,12),cex = 1.2,
     xlim = c(-1,1), xaxs = "r", main = "Heterogeneous", col=c("black","blue","red"),cex.lab=0.9)
