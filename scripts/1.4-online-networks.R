...
source("~/Desktop/facebookdeprivation_bh-master/scripts/1.3-offline-networks.R") 
...
# First calculate continuous measure of the diversity score
...
# -------------- Shannon Entropy:  forming diversity continuous measure and binary equal and above/below median index
# First calculate continuous measure of the diversity score
for (i in 1:length(final_data$code)){
...
# ----------- Majority Share Online: forming diversity continuous measure and binary equal and above/below median index
# First calculate continuous measure of the diversity score
...
# ---------------------------------------------------------
#    INTERACTION w/ CONTINUOUS MEASURE [online]: TABLE S19
# ---------------------------------------------------------
